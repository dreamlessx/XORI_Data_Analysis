...
Metric $P$ showed a strong negative correlation with cortical depth at the
site level ($r = -0.706$, $p = 2.72 \times 10^{-5}$, $n = 28$;
Figure~\ref{fig:depth}A). Superficial sites (140--266~$\mu$m) exhibited
$P > 1$, indicating facilitation---the observed plaid response exceeded the
linear prediction. Deeper sites (392--518~$\mu$m) exhibited $P < 1$,
indicating suppression. The transition from facilitation to suppression
